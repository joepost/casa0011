extensions [ gis ]
globals [ borough-dataset
          elevation-dataset ]
breed [ borough-vertices borough-vertex ]
breed [ borough-labels borough-label ]
patches-own [ population borough-name elevation ]
...
to setup
  ...
  set borough-dataset gis:load-dataset "data/londonBoroughs.shp"
  ;set elevation-dataset gis:load-dataset "data/world-elevation.asc"
  ; Set the world envelope to the union of all of our dataset's envelopes
  gis:set-world-envelope (gis:envelope-of borough-dataset)
  reset-ticks
end
...
to display-boroughs
  ...
  foreach gis:feature-list-of borough-dataset [ vector-feature ->
    gis:set-drawing-color scale-color red (gis:property-value vector-feature "pop2017") 50000 100
...
to display-population-in-patches
  gis:apply-coverage borough-dataset "pop2017" population
  ask patches
  [ ifelse (population > 0)
    [ set pcolor scale-color red population 50000 10 ]
    [ set pcolor blue ] ]
end
